...
# Notification Timing And Retry

## Decision
Implement this area so that route all communications through policy-based delivery contracts with full retention and retry visibility.
...
## Constraints
- [Communication] secure messaging and notices
