...
# Leave Roster Conflict Rules

## Decision
Implement this area so that capture workforce lifecycle as stateful records with coverage constraints and privacy boundaries.

## Evidence
- [inital-research/staff_facing_hr_and_workforce_management_capabilities.md](../../inital-research/staff_facing_hr_and_workforce_management_capabilities.md)
...
## Constraints
- [Workforce] roster/leave continuity
