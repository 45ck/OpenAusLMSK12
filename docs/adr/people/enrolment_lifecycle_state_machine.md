...
# Enrolment Lifecycle State Machine

## Decision
Implement this area so that define immutable lifecycle transitions for enquiry->application->acceptance->enrolment->active.

## Evidence
- [inital-research/deep_research_report_on_australian_school_admissions_and_enrolment_platforms_and_end_to_end_workflows.md](../../inital-research/deep_research_report_on_australian_school_admissions_and_enrolment_platforms_and_end_to_end_workflows.md)
- [inital-research/reverse_engineering_the_core_sis_mis_data_model_in_australian_k_12_schools.md](../../inital-research/reverse_engineering_the_core_sis_mis_data_model_in_australian_k_12_schools.md)
- [OPENAUSLMSK12_MASTER_PLAN.md](../../OPENAUSLMSK12_MASTER_PLAN.md)

## Constraints
- [Admissions] enrolment transitions and evidence obligations
...
- Owner Team: Team B (Core School Operations)
