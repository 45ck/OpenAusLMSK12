...
# Consent And Household Access Matrix

## Decision
Implement this area so that force tenant, school, role, and consent checks at every boundary (auth, API, DB, and UI) with deny-by-default.
...
## Constraints
- [Trust] trust boundary + auditability
