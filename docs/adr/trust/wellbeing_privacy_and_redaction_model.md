...
# Wellbeing Privacy And Redaction Model

## Decision
Implement this area so that separate sensitive wellbeing/health workflows with redaction and explicit emergency override controls.
...
## Constraints
- [Wellbeing] confidential data safety
