...
# Attendance Exception Catalogue

## Decision
Implement this area so that treat attendance as event-streamed state machines with emergency-safe override paths.

## Evidence
- [inital-research/comprehensive_school_attendance_system_for_australian_schools.md](../../inital-research/comprehensive_school_attendance_system_for_australian_schools.md)
...
## Constraints
- [Attendance] duty-of-care continuity
